...
from mediapipe import solutions as mp  # Keep this only for drawing utils
...
def print_result(result: vision.HandLandmarkerResult, output_image: vision.Image, timestamp_ms: int):
...
while True:
    ...
    # Use vision.Image here, NOT mp.Image
